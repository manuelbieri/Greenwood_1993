...
//
// Model 2a (log): 
// Model with increased willingness to substitute between 
// home and market
// Additionally: High deviation error of home technology 
// shock
// ------------------------------------------------------
...
//preamble
display("Model with increased willingness to substitute between home and market (logs)")
